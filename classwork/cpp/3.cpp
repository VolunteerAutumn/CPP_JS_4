...
void AddNewLineAtThePosition(int**& arr, int& rows, int cols, int position)
{
...
int main()
{
	...
	cout << "On which position do I add a new row? (0 - 5) >>> ";
	cin >> position;

	cout << "======================================================" << endl;
	PrintArray(A, rows, cols);
	cout << "======================================================" << endl;
	AddNewLineAtThePosition(A, rows, cols, position-1);
	PrintArray(A, rows, cols);
	cout << "======================================================" << endl;
